...
示例项目:[./php-msf/app/Controllers/Api/Pr.php](https://github.com/PGWireless/php-msf/blob/app/app/Controllers/Api/Pr.php)
...
这样访问:http://127.0.0.1:8000/api/pr/feed这样的URL时,正在执行的控制器动作为:Api\Pr::HttpFeed()。
